...
![Pengantar CSS](../../sketchnotes/webdev101-css.png)

> Sketchnote oleh [Tomomi Imura](https://twitter.com/girlie_mac)

## Kuis sebelum membaca

[Kuis sebelum membaca](https://happy-mud-02d95f10f.azurestaticapps.net/quiz/17)

### Pengantar

CSS atau Cascading Style Sheets menyelesaikan masalah penting dalam pengembangan web: bagaimana cara membuat website Anda terlihat bagus. Mendekorasi aplikasi Anda membuatnya lebih bermanfaat dan terlihat lebih bagus. Anda juga dapat menggunakan CSS untuk membuat Responsive Web Design (RWD) - memungkinkan aplikasi Anda terlihat bagus, apa pun ukuran layarnya. CSS bukan hanya tentang membuat aplikasi Anda terlihat bagus; spesifikasinya mencakup animasi dan transformasi yang memungkinkan interaksi yang lebih rumit untuk aplikasi Anda. CSS Working Group membantu mempertahankan spesifikasi CSS saat ini; Anda dapat mengikuti pekerjaan mereka di situs [World Wide Web Consortium's site](https://www.w3.org/Style/CSS/members).

> Catatan, CSS adalah bahasa yang berkembang, seperti semua yang ada di web dan tidak semua browser mendukung bagian spesifikasi yang lebih baru. Selalu periksa implementasi Anda dengan berkonsultasi di [CanIUse.com](https://caniuse.com).

Pada pelajaran ini, kita akan menambahkan _styles_ ke terrarium kita dan belajar lebih banyak tentang beberapa konsep CSS: cascade, inheritance dan penggunaan selector, positioning dan menggunakan CSS untuk membangun layout. Dalam prosesnya kita akan mengatur tata letak terrarium dan membuat terrarium itu sendiri.

### Prasyarat

Anda harus memilik HTML untuk terrarium Anda dan siap untuk ditata.

### Tugas

Di folder terraium Anda, buat file baru `style.css`. Impor file itu ke dalam bagian `<head>`:
...
Cascading Style Sheets menggabungkan gagasan bahwa _style_ 'cascade' sedemikian rupa sehingga penerapan _styles_ dipandu oleh prioritasnya. _Styles_ yang ditetapkan oleh developer lebih diprioritaskan daripada _styles_ yang ditetapkan oleh browser. _Style_ yang ditetapkan 'inline' lebih diprioritaskan daripada yang diatur dalam file css eksternal.

### Tugas

Tambahkan _inline style_ "color: red" ke tag `<h1> Anda:

```HTML
<h1 style="color: red">My Terrarium</h1>
```

Kemudian tambahkan kode dibawah ini ke file `style.css` Anda:
